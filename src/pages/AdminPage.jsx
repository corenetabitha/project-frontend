...
const Admin = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="mb-8">
        <div className="mb-6">
          <h1 className="text-5xl font-extrabold text-indigo-600">Admin Dashboard</h1>
      ...
      <div className="flex gap-4 mb-6">
        <button
          ...
          className={`px-4 py-2 rounded ${activeTab === "books" ? "bg-blue-400 text-white" : "bg-white shadow"}`}
        >
          Book Management
        </button>
        <button
          onClick={() => setActiveTab("orders")}
          className={`px-4 py-2 rounded ${activeTab === "orders" ? "bg-blue-400 text-white" : "bg-white shadow"}`}
        >
          Order Management
        </button>
        <button
          onClick={() => setActiveTab("lending")}
          className={`px-4 py-2 rounded ${activeTab === "lending" ? "bg-blue-400 text-white" : "bg-white shadow"}`}
        >
          Lending Requests
        </button>
      </div>
